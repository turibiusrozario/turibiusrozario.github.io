...
olid: OL34119145M # use Open Library ID to fetch cover (if no `cover` is provided)
isbn: 9781523091683 # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
categories: book
tags: social
buy_link: https://www.converge.net/book
date: 2026-05-24
started: 2026-03-26
finished: 2026-05-24
# released: 2017
...
[Online Toolkit](https://www.converge.net/networktoolkit)
...
- kumu.io
- Page 39, "While hierarchical leaders focus on the quantity and quality of _their own_ relationships with others, network leaders focus on increasing the quantity and quality of relationships _between_ others.
...
- Page 72, both _trust_ and _action_ are important
...
- Page 75, do not make strict plans that dictate action :sob:, instead, do **Deliberate process, emergent results**
- Page 76, groups don't think: they avoid conflicting ideas and this is problematic
...
- [ ] Check online list for favorite framing questions [Link](https://www.converge.net/toolkit/framing-questions)
...
- Page 141, consider people's internal context: the _why_ behind their actions
...
- [ ] Group Agreements for Networks. [Link](https://www.converge.net/toolkit/group-agreements-for-networks-2)
...
- [ ] Building an Asset Map. [Link](https://www.converge.net/toolkit/building-an-asset-map)
- [ ] Tech Tools for Impact Networks. [Link](https://www.converge.net/toolkit/tech-tools-for-impact-networks)
...
- [ ] Rapid Coordination. [Link](https://www.converge.net/toolkit/rapid-coordination)
...
- Page 191, steps for consent-based decision making
  1.  Context: Consider the decisions already made, the circumstances that decision has to be made in
  2.  Clarification: Allow participants to ask questions but not evaluate. Encourage others to consider purpose, principles, and benefits to the network/themselves
  3.  Consent: Restate purpose. Then ask for vote. Vote with 0 to 5:
      - 5: lead
      - 4: partner
      - 3: follow
  ...
  4.  Have 0s and 1s meet with 4s and 5s to resolve issues
- Page 195, fundamental evaluation criteria for networks
  ...
  - Network connectivity: asses how connected network is with SNA, about every six months or other regular interval
    - [ ] Social network analysis. [Link](https://www.converge.net/toolkit/conducting-a-social-network-analysis)
  - Participant experience: does the members demonstrate shared purpose, principles, trust in relationships, structure/agreement, coordination, resources, and values
    - [ ] Network Participant Survey. [Link](https://www.converge.net/toolkit/network-participant-survey)
    - [ ] Indicators of Network Health. [Link](https://www.converge.net/toolkit/indicators-of-network-health)
